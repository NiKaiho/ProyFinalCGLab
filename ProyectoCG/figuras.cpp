...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text, GLuint text2)  //Funcion creacion cielo
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);  //Top
			glNormal3f(0.0f, 1.0f, 0.0f);
			glTexCoord2f(.0f, 1.0f); glVertex3fv(vertice[4]);
			glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[5]);
...
void CFiguras::prisma7(float altura, float largo, float profundidad, GLuint text, GLuint text1)  //Funcion creacion prisma
{
