...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint Front, GLuint Back, GLuint Left, GLuint Right, GLuint Top, GLuint Bottom)  //Funcion creacion cielo
{
...
void CFiguras::skybox2(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, 50.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(50.0f, 50.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(50.0f, 0.0f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(50.0f, 0.0f); glVertex3fv(vertice[3]);
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(50.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(50.0f, 50.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 50.0f); glVertex3fv(vertice[3]);
	glEnd();
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(50.0f, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(50.0f, 50.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 50.0f); glVertex3fv(vertice[7]);
	glEnd();
}
